...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2016 at 01:17 AM
...
INSERT INTO `tentleaders` (`CAMPING_ID`, `USER_ID`, `ARRIVALDATE`) VALUES
(10001, 1123, 0),
(11112, 1144, 0),
(11113, 1147, 0),
(11114, 1148, 0),
...
--
ALTER TABLE `visitors`
  MODIFY `USER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1160;
