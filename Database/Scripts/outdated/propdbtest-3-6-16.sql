...
--
-- Структура на таблица `foodproducts1`
--

CREATE TABLE `foodproducts1` (
...
--
-- Схема на данните от таблица `foodproducts1`
--

INSERT INTO `foodproducts1` (`PRODUCT_ID`, `NAME`, `PRICE`, `QUANTITY`) VALUES
...
--
-- Indexes for table `foodproducts1`
--
ALTER TABLE `foodproducts1`
...
ALTER TABLE `productstorages`
  ...
  ADD CONSTRAINT `productstorages_ibfk_3` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `foodproducts1` (`PRODUCT_ID`);
